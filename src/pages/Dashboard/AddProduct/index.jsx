...
function AddProduct() {
   ...
   const handleImage = (e) => {
      ...
      const path = URL.createObjectURL(imageFile)

      setInputFields({ ...inputFiels, image: imageFile, image_path: path });
   };
   ...
   const handleSubmit = async (e) => {
      ...
      formData.append("features", productInfo.features);
      formData.append("cur_price", productInfo.cur_price);
      formData.append("quantity", productInfo.quantity);

      try {
         const controller = new AbortController();
         await privateRequest.post("/admin/products", formData, {
